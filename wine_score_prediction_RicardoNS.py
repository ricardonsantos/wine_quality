...
# ## Teste Cognitivo.AI
# Criar um modelo para estimar a qualidade de vinhos a partir de variáveis fisico-químicas e sensoriais 
...
params = {'model__max_depth':range(2,4),'model__n_estimators':range(50,951,100),
          'model__learning_rate':np.logspace(-3,-1,3),'model__random_state':[2001]}
oraculo(X, y,[GradientBoostingRegressor()],params)
